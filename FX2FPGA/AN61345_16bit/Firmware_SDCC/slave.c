...
//  FIFOPINPOLAR |= 0x03;
  ...
  IFCONFIG = 0x03;  //external clock input, Slave FIFO interface	//	hong : fix to receive IFCLK from external
  SYNCDELAY;
  ...
  EP2FIFOCFG = 0x10;            // AUTOOUT=1, WORDWIDE=0 // hong : 8 bit interface
  
  SYNCDELAY;                    // 
  //EP6FIFOCFG = 0x0D;            // AUTOIN=1, ZEROLENIN=1, WORDWIDE=1
  EP6FIFOCFG = 0x0C;            // AUTOIN=1, ZEROLENIN=1, WORDWIDE=0 //hong : 8 bit interface
